...
class  RaportZone3ShortFragment : BaseFragment() {
    ...
    private fun editReportZoneClick(raport: Raport) {
        ...
        raport.lr1?.let { zone3_report_lp1.setChecked(it) }
        raport.lr2?.let { zone3_report_lp2.setChecked(it) }
        raport.lr3?.let { zone3_report_lp3.setChecked(it) }
        raport.lr4?.let { zone3_report_lp4.setChecked(it) }
        raport.lr5?.let { zone3_report_lp5.setChecked(it) }
        raport.lr6?.let { zone3_report_lp6.setChecked(it) }
        raport.lr7?.let { zone3_report_lp7.setChecked(it) }
        raport.lr8?.let { zone3_report_lp8.setChecked(it) }
        raport.lr9?.let { zone3_report_lp9.setChecked(it) }
        raport.lr10?.let { zone3_report_lp10.setChecked(it) }
        raport.lr11?.let { zone3_report_lp11.setChecked(it) }
        raport.lr12?.let { zone3_report_lp12.setChecked(it) }
        raport.lr13?.let { zone3_report_lp13.setChecked(it) }
