...
private fun editReportZoneClick(raport: Raport) {
    ...
    raport.lr1?.let { zone2_report_lp1.isChecked = it }
    raport.lr2?.let { zone2_report_lp2.isChecked = it }
    raport.lr3?.let { zone2_report_lp3.isChecked = it }
    raport.lr4?.let { zone2_report_lp4.isChecked = it }
    raport.lr5?.let { zone2_report_lp5.isChecked = it }
    raport.lr6?.let { zone2_report_lp6.isChecked = it }
    raport.lr7?.let { zone2_report_lp7.isChecked = it }
    raport.lr8?.let { zone2_report_lp8.isChecked = it }
    raport.lr9?.let { zone2_report_lp9.isChecked = it }
    raport.lr10?.let { zone2_report_lp10.isChecked = it }
    raport.lr11?.let { zone2_report_lp11.isChecked = it }
    raport.lr12?.let { zone2_report_lp12.isChecked = it }
    raport.lr13?.let { zone2_report_lp13.isChecked = it }
    raport.lr14?.let { zone2_report_lp14.isChecked = it }
    raport.lr15?.let { zone2_report_lp15.isChecked = it }
    raport.lr21?.let { zone2_report_lp21.isChecked = it }
    raport.lr22?.let { zone2_report_lp22.isChecked = it }
    raport.lr23?.let { zone2_report_lp23.isChecked = it }
    raport.lr24?.let { zone2_report_lp22.isChecked = it }
    raport.lr25?.let { zone2_report_lp23.isChecked = it }

    if (raport.uid != auth.currentUser?.uid) {
        zone2_name_spinner.isEnabled = false
        zone2_report_lp1.isEnabled = false
        zone2_report_lp2.isEnabled = false
        zone2_report_lp3.isEnabled = false
        zone2_report_lp4.isEnabled = false
        zone2_report_lp5.isEnabled = false
        zone2_report_lp6.isEnabled = false
        zone2_report_lp7.isEnabled = false
        zone2_report_lp8.isEnabled = false
        zone2_report_lp9.isEnabled = false
        zone2_report_lp10.isEnabled = false
        zone2_report_lp11.isEnabled = false
        zone2_report_lp12.isEnabled = false
        zone2_report_lp13.isEnabled = false
        zone2_report_lp14.isEnabled = false
        zone2_report_lp15.isEnabled = false
        zone2_report_lp21.isEnabled = false
        zone2_report_lp22.isEnabled = false
        zone2_report_lp23.isEnabled = false
        zone2_report_lp24.isEnabled = false
        zone2_report_lp25.isEnabled = false
    ...
    private fun openReportZone2Click(argumentRaport: Any?) {
        ...
        if (argumentRaport != null) {
            ...
            data.put("zone", "Strefa 2 - okresowo")
