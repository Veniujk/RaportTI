...
class  RaportZone6Fragment : BaseFragment() {
    ...
    private fun editReportZoneClick(raport: Raport) {
        ...
        raport.lr1?.let { zone6_report_lp1.isChecked = it }
        raport.lr2?.let { zone6_report_lp2.isChecked = it }
        raport.lr3?.let { zone6_report_lp3.isChecked = it }
        raport.lr4?.let { zone6_report_lp4.isChecked = it }
        raport.lr5?.let { zone6_report_lp5.isChecked = it }
        raport.lr6?.let { zone6_report_lp6.isChecked = it }
        raport.lr7?.let { zone6_report_lp1.isChecked = it }
        raport.lr8?.let { zone6_report_lp2.isChecked = it }
        raport.lr9a?.let { zone6_report_lp9a.isChecked = it }
        raport.lr9b?.let { zone6_report_lp9b.isChecked = it }
        raport.lr9c?.let { zone6_report_lp9c.isChecked = it }
        raport.lr9d?.let { zone6_report_lp9d.isChecked = it }
        raport.lr21?.let { zone6_report_lp21.isChecked = it }
        raport.lr22?.let { zone6_report_lp22.isChecked = it }
        raport.lr23?.let { zone6_report_lp23.isChecked = it }
        raport.lr24?.let { zone6_report_lp24.isChecked = it }
        raport.lr25?.let { zone6_report_lp25.isChecked = it }
        raport.lr26?.let { zone6_report_lp26.isChecked = it }
        raport.lr27?.let { zone6_report_lp25.isChecked = it }
        raport.lr28?.let { zone6_report_lp26.isChecked = it }
        if (raport.uid != auth.currentUser?.uid) {
            zone6_report_lp1.isEnabled = false
            zone6_report_lp2.isEnabled = false
            zone6_report_lp3.isEnabled = false
            zone6_report_lp4.isEnabled = false
            zone6_report_lp5.isEnabled = false
            zone6_report_lp6.isEnabled = false
            zone6_report_lp7.isEnabled = false
            zone6_report_lp8.isEnabled = false
            zone6_report_lp9a.isEnabled = false
            zone6_report_lp9b.isEnabled = false
            zone6_report_lp9c.isEnabled = false
            zone6_report_lp9d.isEnabled = false
            zone6_report_lp21.isEnabled = false
            zone6_report_lp22.isEnabled = false
            zone6_report_lp23.isEnabled = false
            zone6_report_lp24.isEnabled = false
            zone6_report_lp25.isEnabled = false
            zone6_report_lp26.isEnabled = false
            zone6_report_lp27.isEnabled = false
            zone6_report_lp28.isEnabled = false
        }
    }
