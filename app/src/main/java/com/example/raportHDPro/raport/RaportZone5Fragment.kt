...
class  RaportZone5Fragment : BaseFragment() {
    ...
    private fun editReportZoneClick(raport: Raport) {
       /* raport.name?.let { getIndex(zone1_name_spinner, it) }?.let {
        ...
        raport.lr21?.let { zone5_report_lp21.isChecked = it }
        raport.lr22?.let { zone5_report_lp22.isChecked = it }
        raport.lr23?.let { zone5_report_lp23.isChecked = it }
        raport.lr24?.let { zone5_report_lp24.isChecked = it }
        raport.lr25?.let { zone5_report_lp25.isChecked = it }
        raport.lr26?.let { zone5_report_lp26.isChecked = it }
        if (raport.uid != auth.currentUser?.uid) {
            ...
            zone5_report_lp21.isEnabled = false
            zone5_report_lp22.isEnabled = false
            zone5_report_lp23.isEnabled = false
            zone5_report_lp24.isEnabled = false
            zone5_report_lp25.isEnabled = false
            zone5_report_lp26.isEnabled = false
        }
